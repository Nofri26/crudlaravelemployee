        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="form-group">
                ...
                <input name="alamat" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan Alamat">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input name="no_telp" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan No Telp">
            </div>
